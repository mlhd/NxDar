...
echo_and_run cd "/home/frank/Lidar/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/frank/Lidar/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/frank/Lidar/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
