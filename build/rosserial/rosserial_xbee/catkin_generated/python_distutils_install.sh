...
echo_and_run cd "/home/frank/Lidar/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/frank/Lidar/src/rosserial/rosserial_xbee/setup.py" \
    build --build-base "/home/frank/Lidar/build/rosserial/rosserial_xbee" \
    install \
    $DESTDIR_ARG \
