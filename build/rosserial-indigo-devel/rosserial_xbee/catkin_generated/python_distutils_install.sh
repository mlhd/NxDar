...
echo_and_run cd "/home/frank/Lidar/src/rosserial-indigo-devel/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/frank/Lidar/src/rosserial-indigo-devel/rosserial_xbee/setup.py" \
    build --build-base "/home/frank/Lidar/build/rosserial-indigo-devel/rosserial_xbee" \
    install \
    $DESTDIR_ARG \
