...
echo_and_run cd "/home/frank/Lidar/src/rosserial-indigo-devel/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/frank/Lidar/src/rosserial-indigo-devel/rosserial_python/setup.py" \
    build --build-base "/home/frank/Lidar/build/rosserial-indigo-devel/rosserial_python" \
    install \
    $DESTDIR_ARG \
